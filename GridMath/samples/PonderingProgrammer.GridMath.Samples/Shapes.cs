...
namespace PonderingProgrammer.GridMath.Samples
{
    public static class Shapes
    {
        ...
        private static IEnumerable<IGridShape> CreateOtherFans()
        {
            ...
            var up = new GridFan(center.Translation(0, -1), 5, Grid8Direction.Top);
            var down = new GridFan(center.Translation(0, 1), 6, Grid8Direction.Bottom);
            var left = new GridFan(center.Translation(-1, 0), 7, Grid8Direction.Left);
            var right = new GridFan(center.Translation(1, 0), 8, Grid8Direction.Right);
        ...
        {
            var center = new GridCoordinatePair(30, 20);
            var upLeft = new GridFan(center.Translation(-1, -1), 10, Grid8Direction.TopLeft);
            var upRight = new GridFan(center.Translation(1, -1), 10, Grid8Direction.TopRight);
            var downLeft = new GridFan(center.Translation(-1, 1), 10, Grid8Direction.BottomLeft);
            var downRight = new GridFan(center.Translation(1, 1), 10, Grid8Direction.BottomRight);
